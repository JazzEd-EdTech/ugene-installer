...
function Component()
{
    ...
    installer.componentByName("full.tools.i386.bedtools2").setValue("Virtual", "true");
    installer.componentByName("full.tools.i386.bedtools2").setValue("Default", "false");
    installer.componentByName("full.tools.x86_64.bedtools2").setValue("Virtual", "true");
    installer.componentByName("full.tools.x86_64.bedtools2").setValue("Default", "false");

    if (systemInfo.currentCpuArchitecture === "i386") {
        installer.componentByName("full.tools.i386.bedtools2").setValue("Virtual", "false");
        installer.componentByName("full.tools.i386.bedtools2").setValue("Default", "true");
    }
    if (systemInfo.currentCpuArchitecture === "x86_64") {
        installer.componentByName("full.tools.x86_64.bedtools2").setValue("Virtual", "false");
        installer.componentByName("full.tools.x86_64.bedtools2").setValue("Default", "true");
    }
}
