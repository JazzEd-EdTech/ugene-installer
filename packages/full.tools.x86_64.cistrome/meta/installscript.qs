...
function Component()
{
    ...
    installer.componentByName("full.tools.x86_64.cistrome").setValue("Virtual", "true");
    installer.componentByName("full.tools.x86_64.cistrome").setValue("Default", "false");

    if (validOs && systemInfo.currentCpuArchitecture === "x86_64") {
        installer.componentByName("full.tools.x86_64.cistrome").setValue("Virtual", "false");
        installer.componentByName("full.tools.x86_64.cistrome").setValue("Default", "true");
    }
}
