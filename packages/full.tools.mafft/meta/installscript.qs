...
function Component()
{
    ...
    installer.componentByName("full.tools.i386.mafft").setValue("Virtual", "true");
    installer.componentByName("full.tools.i386.mafft").setValue("Default", "false");
    installer.componentByName("full.tools.x86_64.mafft").setValue("Virtual", "true");
    installer.componentByName("full.tools.x86_64.mafft").setValue("Default", "false");

    if (systemInfo.currentCpuArchitecture === "i386") {
        installer.componentByName("full.tools.i386.mafft").setValue("Virtual", "false");
        installer.componentByName("full.tools.i386.mafft").setValue("Default", "true");
    }
    if (systemInfo.currentCpuArchitecture === "x86_64") {
        installer.componentByName("full.tools.x86_64.mafft").setValue("Virtual", "false");
        installer.componentByName("full.tools.x86_64.mafft").setValue("Default", "true");
    }
}
