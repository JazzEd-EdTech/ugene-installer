...
function Component()
{
    ...
    installer.componentByName("full.tools.i386.mrbayes").setValue("Virtual", "true");
    installer.componentByName("full.tools.i386.mrbayes").setValue("Default", "false");
    installer.componentByName("full.tools.x86_64.mrbayes").setValue("Virtual", "true");
    installer.componentByName("full.tools.x86_64.mrbayes").setValue("Default", "false");

    if (systemInfo.currentCpuArchitecture === "i386") {
        installer.componentByName("full.tools.i386.mrbayes").setValue("Virtual", "false");
        installer.componentByName("full.tools.i386.mrbayes").setValue("Default", "true");
    }
    if (systemInfo.currentCpuArchitecture === "x86_64") {
        installer.componentByName("full.tools.x86_64.mrbayes").setValue("Virtual", "false");
        installer.componentByName("full.tools.x86_64.mrbayes").setValue("Default", "true");
    }
}
