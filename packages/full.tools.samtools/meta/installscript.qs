...
function Component()
{
    ...
    installer.componentByName("full.tools.i386.samtools").setValue("Virtual", "true");
    installer.componentByName("full.tools.i386.samtools").setValue("Default", "false");
    installer.componentByName("full.tools.x86_64.samtools").setValue("Virtual", "true");
    installer.componentByName("full.tools.x86_64.samtools").setValue("Default", "false");

    if (systemInfo.currentCpuArchitecture === "i386") {
        installer.componentByName("full.tools.i386.samtools").setValue("Virtual", "false");
        installer.componentByName("full.tools.i386.samtools").setValue("Default", "true");
    }
    if (systemInfo.currentCpuArchitecture === "x86_64") {
        installer.componentByName("full.tools.x86_64.samtools").setValue("Virtual", "false");
        installer.componentByName("full.tools.x86_64.samtools").setValue("Default", "true");
    }
}
