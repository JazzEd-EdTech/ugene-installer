...
function Component()
{
    ...
    installer.componentByName("full.tools.i386.CAP3").setValue("Virtual", "true");
    installer.componentByName("full.tools.i386.CAP3").setValue("Default", "false");
    installer.componentByName("full.tools.x86_64.CAP3").setValue("Virtual", "true");
    installer.componentByName("full.tools.x86_64.CAP3").setValue("Default", "false");

    if (systemInfo.currentCpuArchitecture === "i386") {
        installer.componentByName("full.tools.i386.CAP3").setValue("Virtual", "false");
        installer.componentByName("full.tools.i386.CAP3").setValue("Default", "true");
    }
    if (systemInfo.currentCpuArchitecture === "x86_64") {
        installer.componentByName("full.tools.x86_64.CAP3").setValue("Virtual", "false");
        installer.componentByName("full.tools.x86_64.CAP3").setValue("Default", "true");
    }
}
