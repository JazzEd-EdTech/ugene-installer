...
function Component()
{
    ...
    installer.componentByName("full.tools.i386.perl").setValue("Virtual", "true");
    installer.componentByName("full.tools.i386.perl").setValue("Default", "false");
    installer.componentByName("full.tools.x86_64.perl").setValue("Virtual", "true");
    installer.componentByName("full.tools.x86_64.perl").setValue("Default", "false");

    if (systemInfo.currentCpuArchitecture === "i386") {
        installer.componentByName("full.tools.i386.perl").setValue("Virtual", "false");
        installer.componentByName("full.tools.i386.perl").setValue("Default", "true");
    }
    if (systemInfo.currentCpuArchitecture === "x86_64") {
        installer.componentByName("full.tools.x86_64.perl").setValue("Virtual", "false");
        installer.componentByName("full.tools.x86_64.perl").setValue("Default", "true");
    }
}
