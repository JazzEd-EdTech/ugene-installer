...
function Component()
{
    ...
    installer.componentByName("full.tools.x86_64.bedGraphToBigWig").setValue("Virtual", "true");
    installer.componentByName("full.tools.x86_64.bedGraphToBigWig").setValue("Default", "false");

    if ( systemInfo.currentCpuArchitecture === "x86_64") {
        installer.componentByName("full.tools.x86_64.bedGraphToBigWig").setValue("Virtual", "false");
        installer.componentByName("full.tools.x86_64.bedGraphToBigWig").setValue("Default", "true");
    }
}
