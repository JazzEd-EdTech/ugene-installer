...
function Component()
{
    ...
    installer.componentByName("full.tools.x86_64.SPAdes").setValue("Virtual", "true");
    installer.componentByName("full.tools.x86_64.SPAdes").setValue("Default", "false");

    if (validOs && systemInfo.currentCpuArchitecture === "x86_64") {
        installer.componentByName("full.tools.x86_64.SPAdes").setValue("Virtual", "false");
        installer.componentByName("full.tools.x86_64.SPAdes").setValue("Default", "true");
    }
}
