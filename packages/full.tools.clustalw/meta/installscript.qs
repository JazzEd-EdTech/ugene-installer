...
function Component()
{
    ...
    installer.componentByName("full.tools.i386.clustalw").setValue("Virtual", "true");
    installer.componentByName("full.tools.i386.clustalw").setValue("Default", "false");
    installer.componentByName("full.tools.x86_64.clustalw").setValue("Virtual", "true");
    installer.componentByName("full.tools.x86_64.clustalw").setValue("Default", "false");

    if (systemInfo.currentCpuArchitecture === "i386") {
        installer.componentByName("full.tools.i386.clustalw").setValue("Virtual", "false");
        installer.componentByName("full.tools.i386.clustalw").setValue("Default", "true");
    }
    if (systemInfo.currentCpuArchitecture === "x86_64") {
        installer.componentByName("full.tools.x86_64.clustalw").setValue("Virtual", "false");
        installer.componentByName("full.tools.x86_64.clustalw").setValue("Default", "true");
    }
}
